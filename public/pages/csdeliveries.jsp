...
<stripes:layout-render name="/pages/common/template.jsp" pageTitle="Advanced search">
	...
	<stripes:layout-component name="contents">
        ...
        <display:table name="${actionBean.deliveries}" class="sortable" pagesize="50" sort="list" id="listItem" htmlId="listItem" requestURI="/csdeliveries" decorator="eionet.rod.web.util.CSDeliveriesTableDecorator" style="width:100%">
