...
<stripes:layout-render name="/pages/common/template.jsp" pageTitle="${page_title}">
  ...
  <stripes:layout-component name="contents">
        ...
        <stripes:form action="${actionBean.actionUrl}" method="get">
        ...
        <tr>
          ...
          <td valign="middle" width="10%" class="help_btn">
            <p align="right">
              <a href="javascript:openViewHelp('HELP_CSMAIN1')"><img src="${actionBean.contextPath}/images/info_icon.gif" alt="Show help" border="0"/></a>
            </p>
          </td>
        </tr>
        <tr>
        ...
        <display:table name="${actionBean.searchList}" class="sortable" pagesize="50" sort="list" id="listItem" htmlId="listItem" requestURI="${actionBean.actionUrl}" decorator="eionet.rod.web.util.DeadlinesTableDecorator" style="width:100%" excludedParams="idspatial tab">
