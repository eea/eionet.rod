        ...
        <stripes:form action="/subscribe" method="post">
            <table class="formtable" style="border: 1px solid #008080" cellpadding="2" cellspacing="0" width="600" border="0">
                ...
                <tr>
                    ...
                    <td>
                        <c:choose>
                            <c:when test="${!empty actionBean.clientName}">
                                ${rodfn:replaceTags(actionBean.clientName)}
                                    ...
                                    <c:forEach items="${actionBean.clients}" var="client" varStatus="loop">
                                        <c:choose>
                                            <c:when test="${!empty client.acronym}">
                                                <c:set var="fullName" value="${client.acronym} - ${client.name}" />
                ...
                <tr>
                    ...
                    <td>
                        <c:choose>
                            <c:when test="${!empty actionBean.obligationName}">
                ...
                <tr>
                    ...
                    <td>
                        <c:choose>
                            <c:when test="${!empty actionBean.instrumentName}">
