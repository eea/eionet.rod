 ...
 *
 */
@UrlBinding("/eobligation")
public class AddEditObligationActionBean extends AbstractRODActionBean implements ValidationErrorHandler {
	...
	public Resolution init() throws ServiceException {
		Resolution resolution = new ForwardResolution("/pages/eobligation.jsp");
