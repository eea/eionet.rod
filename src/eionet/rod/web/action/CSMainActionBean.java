 ...
 */
@UrlBinding("/csmain")
public class CSMainActionBean extends AbstractRODActionBean {

	private List<CountryDTO> countries;
	private List<IssueDTO> issues;
	private List<ClientDTO> clients;
	
	private List<CSSearchDTO> searchList;
	...
	public Resolution search() throws ServiceException {
		...
		return new ForwardResolution("/pages/csmain.jsp");
	}
	...
	public List<CSSearchDTO> getSearchList() {
		return searchList;
	}

	public void setSearchList(List<CSSearchDTO> searchList) {
