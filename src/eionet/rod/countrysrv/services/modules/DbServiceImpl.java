...
package eionet.rod.countrysrv.services.modules;
...
import eionet.rod.countrysrv.services.CSServices;
import eionet.rod.countrysrv.services.FileServiceIF;
import eionet.rod.countrysrv.services.DbServiceIF;
import eionet.rod.countrysrv.services.ServiceException;
...
*/
  public DbServiceImpl() throws ServiceException {
      ...
      dbUrl = CSServices.getFileService().getStringProperty( FileServiceIF.DB_URL);
      dbDriver = CSServices.getFileService().getStringProperty( FileServiceIF.DB_DRV);
      dbUser = CSServices.getFileService().getStringProperty( FileServiceIF.DB_USER_ID);
      dbPsw = CSServices.getFileService().getStringProperty( FileServiceIF.DB_USER_PWD);

      rodDomain  = CSServices.getFileService().getStringProperty( ROD_URL_DOMAIN );

      crUrlPref = CSServices.getFileService().getStringProperty( FileServiceIF.CR_URL_PREFIX);
// metadata attr names->
//<-
